...
import com.bookmanage.bms.utils.TokenProcessor;
...
public class UserController {
    ...
    public Map<String, Object> login(@RequestBody User user) {
        ...
        if(userObj == null) {   // 账号或密码错误
            // 返回结果对象
            return Result.getResultMap(420, "账号或密码错误");
        } else {    // 账号密码正确
            // 创建token
            ...
            // 返回结果对象
            return Result.getResultMap(200, "登录成功",
    ...
    public Map<String, Object> info(String token) {
        ...
        if(user == null) {  // 获取失败
            return Result.getResultMap(420, "获取用户信息失败");
        } else {    // 获取成功
            return Result.getResultMap(200, "获取用户信息成功", user);
        }
    }
    ...
    public Map<String, Object> logout(String token) {
        ...
        return Result.getResultMap(200, "退出登录成功" );
    }
    ...
    public Map<String, Object> queryUsersByPage(@RequestParam Map<String, Object> params){
        ...
        List<User> users = userService.searchUsersByPage(params); //泛型列表
        return Result.getListResultMap(0, "success", count, users); //将查询结果封装成响应的格式并返回
    }
